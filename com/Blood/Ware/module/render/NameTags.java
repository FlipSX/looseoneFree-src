...
public class NameTags extends Module {
   ...
   public void onRenderWorld(RenderWorldLastEvent renderWorldLastEvent) {
      ...
      int n25;
      Iterator var27;
      if (Objects.equals(valString, "Loose")) {
         ...
         while(true) {
            while(true) {
               ...
               if (FriendManager.FRIENDS.contains(entity3.getName())) {
                  ...
                  Gui.drawRect(-mc.fontRenderer.getStringWidth(String.valueOf((new StringBuilder()).append("LooseOne").append(" ").append(n22).append("%"))) / 2 - 2, -2, mc.fontRenderer.getStringWidth("LooseOne") / 2 + 16, 10, FriendManager.FRIENDS.contains(entity3.getName()) ? Color.green.getRGB() : Integer.MIN_VALUE);
                  mc.fontRenderer.drawString(String.valueOf((new StringBuilder()).append("LooseOne").append(" ").append(TextFormatting.GREEN).append(n22).append("%")), -this.center(String.valueOf((new StringBuilder()).append("LooseOne").append(" ").append(TextFormatting.DARK_GREEN).append(n22).append("%"))), 1, -1);
         ...
         int k;
         if (Objects.equals(valString, "Loose1")) {
            var3 = mc.world.loadedEntityList.iterator();
         ...
         } else if (Objects.equals(valString, "Loose2")) {
            var3 = mc.world.loadedEntityList.iterator();
   ...
   public NameTags() {
      ...
      Modes.add("Loose1");
      Modes.add("Loose2");
      BloodWare.instance.settingsManager.rSetting(new Setting("Modes", this, "Blood", (ArrayList)Modes));
   }
