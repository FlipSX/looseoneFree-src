...
public class HUD extends Module {
   ...
   public HUD() {
      ...
      Modes.add("Loose");
      Modes.add("LooseOne");
      Modes.add("LooseSkeet");
      BloodWare.instance.settingsManager.rSetting(new Setting("Mode", this, "LooseSkeet", Modes));
   ...
   public void onOverlayRender(Text text) {
      ...
      if (valString.equals("Loose")) {
         ...
         if (valString.equals("LooseOne")) {
            ...
            this.modulesSorted.clear();
         } else if (valString.equals("LooseSkeet")) {
            if (text.getType() != ElementType.TEXT || Minecraft.getMinecraft().gameSettings.showDebugInfo) {
               return;
            }
