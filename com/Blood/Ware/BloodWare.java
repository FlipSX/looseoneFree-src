...
public class BloodWare {
   public static String name = "LooseOne Free 0.4";
   public static String cName = "LooseOne Free 0.4";
   public static String FULL_name = "LooseOne Free 0.4";
   ...
   public static void setSession(Session s) {
      ...
      try {
         ...
         name = "LooseOne Free 0.4 | User: " + Minecraft.getMinecraft().getSession().getUsername();
         Display.setTitle(name);
